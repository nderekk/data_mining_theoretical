...
\begin{itemize}
    ...
    \item{\textbf{RQ2}}: To what extent can the observed performance gains be attributed to the learned gating function and to the experts’ ability to capture useful textual characteristics? - The authors employ enother baseline where they assign random weights to the gating function (\textbf{\texttt{RANDOM-GATE}}). 
